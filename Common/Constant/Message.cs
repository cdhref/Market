namespace Market.Object.Constant
{
    ...
    public static class Message
    {
        ...
        public static readonly string failedBecauseDuplicateData = "既に登録されてる企業、又はシステムエラーで失敗しました。";
        public static readonly string failedBecauseDataNotFound = "既に削除されてる企業、又はシステムエラーで失敗しました。";
